const CACHE='antar-obat-stage3-kurir-v3';
const CORE=['./','./index.html','./manifest.webmanifest','./assets/config.js','./assets/api-client.js','./assets/app.js','./assets/farmasi.js','./assets/courier.js','./assets/styles.css','./icons/logo-rsud.png','./icons/icon-192.png','./icons/icon-512.png'];
