...
import { AppsScriptFormTransport, PengantaranApi } from './api-client.js?v=6.1.10-hf5d';
import { createFarmasiModule } from './farmasi.js?v=6.1.10-hf5d';
import { createCourierModule } from './courier.js?v=6.1.10-hf5d';
import { createAdminModule } from './admin.js?v=6.1.10-hf5d';
import { createManagementModule } from './management.js?v=6.1.10-hf5d';
...
async function registerServiceWorker(){
  ...
  const reg=await navigator.serviceWorker.register('./sw.js?v=6.1.10-hf5d',{updateViaCache:'none'});
...
console.info('[Pengantaran Obat] Frontend build 6.1.10-stage6b1-hf5d-metasheet');
