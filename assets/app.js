...
import { AppsScriptFormTransport, PengantaranApi } from './api-client.js?v=6.1.9-hf5c';
import { createFarmasiModule } from './farmasi.js?v=6.1.9-hf5c';
import { createCourierModule } from './courier.js?v=6.1.9-hf5c';
import { createAdminModule } from './admin.js?v=6.1.9-hf5c';
import { createManagementModule } from './management.js?v=6.1.9-hf5c';
...
async function registerServiceWorker(){
  ...
  const reg=await navigator.serviceWorker.register('./sw.js?v=6.1.9-hf5c',{updateViaCache:'none'});
...
console.info('[Pengantaran Obat] Frontend build 6.1.9-stage6b1-hf5c-noteflow');
