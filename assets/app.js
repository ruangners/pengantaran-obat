import { APP_CONFIG } from './config.js?v=1.0.0-rc3a';
import { AppsScriptTransport, PengantaranApi } from './api-client.js?v=1.0.0-rc3a';
import { createFarmasiModule } from './farmasi.js?v=1.0.0-rc3a';
import { createCourierModule } from './courier.js?v=1.0.0-rc3a';
import { createAdminModule } from './admin.js?v=1.0.0-rc3a';
import { createManagementModule } from './management.js?v=1.0.0-rc3a';
...
async function registerServiceWorker() {
  ...
  const registration = await navigator.serviceWorker.register('./sw.js?v=1.0.0-rc3a',{updateViaCache:'none'});
